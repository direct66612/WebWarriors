                  ...
                  <div class="exercise-card-top">
                    ...
                    <button class="exercise-card-remove-btn">
                      <svg
                        ...
                        height="16">
                        <use
                          href="src/img/symbol-defs.svg#icon-exercises-content-garbage"
                        ></use>
                      </svg>
                    </button>
                    <button class="exercise-card-start-btn">
                      ...
                      <svg
                        ...
                        height="16">
                        <use
                          href="src/img/symbol-defs.svg#icon-scroll-arrow"
                        ></use>
                      </svg>
                    </button>
                  </div>
                  <div class="exercise-card-mid">
                    <div class="man-icon-wrapper">
                      <svg
                        ...
                        width="20"
                        height="20">
                        <use href="src/img/symbol-defs.svg#icon-aside-men"></use>
                      </svg>
                    </div>
